...
def test_api_check_password_apprenti(client, apprenti_mdp):
    ...
    data = {"login": apprenti_mdp.login, "password": apprenti_mdp.password}
    ...
    assert response.json["blocage"] is True
    ...
    assert response.json["valide"] is True
...
def test_api_set_password_apprenti(client, apprenti_sans_mdp):
    ...
    data = {"login": generate_login("Mouline", "Jeanne"), "password": "222222"}

    # Ajout d'un mot de passe à un apprenti inexistant
    response = client.post(url_for("api.api_set_password_apprenti"), json=data)
    ...
    data = {"login": apprenti_sans_mdp.login, "password": apprenti_sans_mdp.password}
