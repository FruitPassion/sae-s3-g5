...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_formation'], ['main.Formation.id_formation'], ),
    ...
    op.create_table('EducAdmin',
    sa.Column('id_personnel', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_personnel'], ['main.Personnel.id_personnel'], ),
    sa.PrimaryKeyConstraint('id_personnel'),
    schema='main'
    )
    op.create_table('Assister',
    sa.Column('id_apprenti', sa.Integer(), nullable=False),
    sa.Column('id_cours', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_apprenti'], ['main.Apprenti.id_apprenti'], ),
    sa.ForeignKeyConstraint(['id_cours'], ['main.Cours.id_cours'], ),
    sa.PrimaryKeyConstraint('id_apprenti', 'id_cours'),
    schema='main'
    )
    op.create_table('FicheIntervention',
    ...
    op.create_table('ComposerPresentation',
    ...
    sa.ForeignKeyConstraint(['id_element'], ['main.ElementBase.id_element'], ),
    sa.ForeignKeyConstraint(['id_fiche'], ['main.FicheIntervention.id_fiche'], ),
    sa.ForeignKeyConstraint(['id_materiel'], ['main.Materiel.id_materiel'], ),
    sa.ForeignKeyConstraint(['id_pictogramme'], ['main.Pictogramme.id_pictogramme'], ),
