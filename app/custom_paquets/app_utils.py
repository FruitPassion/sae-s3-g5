    ...
    def handle_error(e):
        ...
        if isinstance(e, HTTPException):
            ...
            try:
                ...
                raise e
        return render_template("common/erreur.html", titre="erreur", erreur=f"Erreur {code}", description=description, description_plus=description_plus, config=config), code
