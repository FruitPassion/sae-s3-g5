...
class Composer(db.Model):
    ...
    id_element = db.Column(db.ForeignKey(f'db_fiches_dev.ElementDefaut.id_element'), primary_key=True)
    id_fiche = db.Column(db.ForeignKey(f'db_fiches_dev.Fiche.id_fiche'), primary_key=True)
